...
public:
	...
	void DrawArrow(const Vector2f& from, const Vector2f& to, const Color& color);
	...
	void DrawString(Font* font, const std::string& text, const Vector2f& pos,
		const Color& color, Align::value_type align = Align::TOP_LEFT);

	Rect2f MeasureString(Font* font, const std::string& text,
		Align::value_type align = Align::TOP_LEFT, float scale = 1.0f);
